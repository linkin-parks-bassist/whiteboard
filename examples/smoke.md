...
scene "smoke" duration 0.25s
  ...
  patch board opacity 0.95 blur 1 jitter 1.25
  ...
  patch model 3d opacity 1 jitter 1.1
    ...
    shade_triangle3d face_fill points (-0.8,-0.2,0.2) (-0.1,0.9,1.0) (0.7,-0.1,0.5) colour green opacity 0.12
    triangle3d face points (-0.8,-0.2,0.2) (-0.1,0.9,1.0) (0.7,-0.1,0.5) thickness 3 colour grey jitter 1.0
    ...
    move demo_cube (0,0) -> (-25,10) 0.04s..0.20s
...
scene "smoke second scene" duration 0.20s
  background radial center #ffffff edge #f1f2f4
  patch board opacity 1 jitter off
